...
const LandingSection = () => {
    return (
        <div className=" bg-no-repeat bg-right-top" style={{backgroundPosition:"right top, left top",backgroundSize:"contain,20%",backgroundImage:"url(/Images/serviceDetails/bg-pattern-webp.webp),url(/Images/serviceDetails/bg-top-left-pattern-webp.webp)"}}>
            <div className="grid grid-cols-1 lg:grid-cols-2  lg:w-11/12 mx-auto px-5 lg:px-10 ">
                <div className=" flex flex-col items-center lg:items-start justify-center text-blue-primary space-y-4 pt-20 text-center lg:text-left">
                    <p className="font-bold text-lg">Achieve a greater business agility</p>
                    <h1 className="main-heading">
                        <span className="text-green-primary font-bold">Blockchain </span>
                ...
                >
                    <img loading="lazy" className="w-full md:w-4/5 lg:w-full" alt="big-data-service" src="/Images/serviceDetails/big-data-service-webp.webp" />
                </div>
            </div>
        </div>
    )
