...
const FourthSection = () => {
  return (
    <>
      <div
        className=" py-28 lg:py-40 flex justify-center items-center bg-contain lg:bg-cover bg-no-repeat bg-center"
        style={{
      ...
      >
        ...
        <div className="text-center text-blue-primary tracking-wider mb-0 lg:mb-12 w-full lg:w-4/6 mx-auto space-y-4">
          ...
          <p className="w-4/5 mx-auto text-base lg:text-lg text-blue-primary my-2 font-medium">
            Whatever is your requirement, we got your back at every stage of
            digital transformation, including web design. We’ve built a core
            system for a bank, an MVP market place sold for millions, and other
            5 custom projects for 140+ companies world wide. All in accordance
            with the client’s digital marketing strategy.
          </p>
        </div>
        {/* text section */}
      </div>
