...
const SecondSection = () => {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 items-center lg:grid-cols-2  px-5 md:px-20   bg-no-repeat bg-right-top rightPatternSize text-center md:text-left" style={{backgroundImage:"url(/Images/serviceAssets/section2/right_pattern-webp.webp)"}}>
                {/* Text section */}
                ...
                <div className=" text-blue-primary tracking-wider mb-12  lg:mt-8  text-justify">
                    ...
                    <p className="font-normal">
                        ...
                        <span className="text-green-primary font-normal"> It means your outsourced team works as well as your 
                            software developers do. </span>
                        Access Custom Software Development services trusted by 98% of CTOs that 
                ...
                <div className="flex items-center justify-center">
                    <img loading="lazy" alt="software development" className="w-4/5" src="/Images/serviceDetails/software development-webp.webp" />
                </div>
                {/* image section */}
