...
const LevelOne = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url(/Images/falling-gems/level2background-webp.webp)",
      }}
    >
      <div className="bg-white flex lg:flex-row flex-col items-center justify-between mx-auto rounded-3xl shadow-md py-10 px-8 md:px-12 space-y-10">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-blue-light text-lg md:text-xl text-center lg:w-10/12 mx-auto">
            Do you want to enjoy snow fall form the comfort of your home? Catch
            these winter items to score more!
          </p>
      ...
      <div
        ...
        style={{ backgroundImage: "url(/Images/falling-gems/snow-back2-webp.webp)" }}
      >
        <VideoModal level="2" videoID={"3CdxghIg0kE"} />
      </div>
    </div>
  );
};
