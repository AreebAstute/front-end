...
const ResponsiveAdvantages = () => {
    ...
    const hiddenBlockStyles = "mt-5 w-full md:w-5/6 text-gray-text text-sm overflow-hidden"
    ...
    return (
        <div className="" >
            <div className="bg-no-repeat bg-right-top lg:w-11/12 lg:mx-auto mx-3 md:mx-5 py-20">
                <h2 className="sub-heading">Advantage from the Laravel framework to build: </h2>
                <div className="grid grid-cols-1 lg:grid-cols-2 mt-10 ">
                    <div className="space-y-3">
                        ...
                        className={`${advantageStyling}`}>
                            ...
                            <p className="flex items-center justify-between text-sm font-bold">Enterprise-level applications
                            {
                                number === 1 && arrowDown ?
