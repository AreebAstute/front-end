...
const WhyKotline = () => {
    return (
        <div className="bg-no-repeat bg-left-bottom bg-transparent leftPatternSize" style={{backgroundImage:"url(/Images/serviceAssets/section2/left_pattern-webp.webp)"}}>
            <div className="w-11/12 mx-auto py-28">
            <h2 className="sub-heading">Why Tech Managers build their Kotlin teams with us:</h2>
