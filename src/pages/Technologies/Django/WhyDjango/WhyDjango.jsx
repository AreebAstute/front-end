...
const WhyDjango = () => {
  return (
    <div
      className="bg-no-repeat bg-left-bottom bg-transparent leftPatternSize"
      style={{
        backgroundImage: "url(/Images/serviceAssets/section2/left_pattern-webp.webp)",
      }}
    >
      <div className="w-11/12 mx-auto py-10 md:py-28">
        <h2 className="sub-heading">
          Why Tech Managers build their Django teams with us:
        </h2>

        <div
          className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 gap-y-20 bg-contain bg-center  bg-no-repeat"
          style={{
            backgroundPositionY: "65%",
            backgroundImage:
              "url(/Images/technologies/top_to_bottom_dotte-webp.webp), url(/Images/technologies/bottom_dotte-webp.webp)",
          }}
        >
          <GreenCard
