...
export const createCamera = () => {
    const camera = new THREE.PerspectiveCamera(1, document.getElementById("modelPlace").clientWidth / document.getElementById("modelPlace").clientHeight, 20, 4000);
