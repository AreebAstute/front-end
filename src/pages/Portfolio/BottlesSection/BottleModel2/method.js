...
export const createCamera = () => {
    const camera = new THREE.PerspectiveCamera(3.6, document.getElementById("modelPlace").clientWidth / document.getElementById("modelPlace").clientHeight, 20, 4000);
...
export const createLight = (scene) => {
    ...
    // scene.add(pointlight,pointLightExtra,pointlightFront,pointlightBack,pointLightRight,pointLightLeft);
