...
export const createCamera = () => {
    ...
    const camera = new THREE.PerspectiveCamera(100,document.getElementById("modelPlace").clientWidth / document.getElementById("modelPlace").clientHeight, 0.1, 4000);
    camera.position.z = 5;
    camera.position.x = 0
    camera.position.y = 0
    return camera;
   ...
   loadingEnvornment = false
    ...
    loader.load(path, function(gltf) {
        ...
        if(!loadingEnvornment){
            ...
            // const clip = THREE.AnimationClip.findByName( clips, 'Hand_R|Hand_RAction' );
