...
export const createCamera = () => {
    ...
    const camera = new THREE.PerspectiveCamera(1.8, document.getElementById("modelPlace").clientWidth / document.getElementById("modelPlace").clientHeight, 20, 4000);
...
export const createLight = (scene) => {
    ...
    const pointLightFront = new THREE.PointLight( 0xffffff , 2, 100);
    pointLightFront.position.set( 0, -2, 1);
    const pointLightFrontHelper = new THREE.PointLightHelper(pointLightFront, 2 , 'black' )
    
    const pointLightback = new THREE.PointLight( 0xffffff , 2, 100);
    pointLightback.position.set( 0, -1, -1);
    const pointLightbackHelper = new THREE.PointLightHelper(pointLightback, 2 , 'red' )
