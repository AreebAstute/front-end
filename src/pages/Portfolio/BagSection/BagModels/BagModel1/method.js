...
export const createCamera = () => {
    const camera = new THREE.PerspectiveCamera(5.7, document.getElementById("modelPlace").clientWidth / document.getElementById("modelPlace").clientHeight, 20, 4000);
...
export const createLight = (scene) => {
    ...
    const pointlightHelper = new THREE.PointLightHelper(pointlightFront, 2, 'red' )

    const pointlightBackTop = new THREE.PointLight(0xffffff, 1, 100);
    pointlightBackTop.position.set(0, 0, -10);
    const pointlightHelper2 = new THREE.PointLightHelper(pointlightBackTop, 2, 'blue' )


    // const directioanLight = new THREE.DirectionalLight(0xffffff, 1, 100);
    // directioanLight.position.set(2, 2, 10);
    // const directioanLightHelper = new THREE.DirectionalLightHelper(directioanLight)
...
export const createModel = (model, scene, path, setLoading,renderer,selectedColor) => { //model is a react ref, remember that
    setLoading(true)
